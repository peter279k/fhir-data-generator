...
class Track1ForCondition:
    ...
    def generate_condition_resource(self):
        ...
        condition_class.set_verification_status_coding(self.payload['verification_status_coding'])

        condition_class.set_category_coding(self.payload['category_coding'])

        condition_class.set_severity_coding(self.payload['severity_coding'])
        ...
        condition_class.set_onset_datetime(self.payload['onset_datetime'])

        condition_class.set_abatement_datetime(self.payload['abatement_datetime'])

...
def test_create(patient_class, profile_urls, identifiers, active, managing_organization, names, gender, birth_date, addresses, telecoms, communications, patient_sc2_payload):

from fixtures.observation_ltc_blood_pressure import *


def test_create(observation_class, profile_urls, status, category_coding, code_coding, code_text, subject, effective_datetime, performer, component, expected_payload):

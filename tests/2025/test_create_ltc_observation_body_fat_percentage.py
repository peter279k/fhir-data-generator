from fixtures.observation_ltc_body_fat_percentage import *


def test_create(observation_class, profile_urls, status, category_coding, code_coding, subject, effective_datetime, performer, value_quantity, interpretation, note, method_coding, device, reference_range, expected_payload):

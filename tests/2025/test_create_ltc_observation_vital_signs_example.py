from fixtures.observation_ltc_vital_signs_example import *


def test_create(observation_class, profile_urls, status, category_coding, code_coding, code_text, subject, effective_datetime, performer, note, has_member, expected_payload):
    ...
    observation_class.set_has_member(has_member)

from fixtures.observation_ltc_pasport_bmi import *


def test_create(observation_class, profile_urls, status, category_coding, code_coding, subject, effective_datetime, performer, value_quantity, interpretation, note, derived_from, expected_payload):
    ...
    observation_class.set_derived_from(derived_from)

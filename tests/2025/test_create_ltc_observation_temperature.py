from fixtures.observation_ltc_temperature import *


def test_create(observation_class, profile_urls, status, category_coding, code_coding, subject, effective_datetime, performer, value_quantity, expected_payload):

from fixtures.observation_ltc_weight import *


def test_create(observation_class, profile_urls, status, category_coding, code_coding, subject, effective_datetime, performer, value_quantity, note, method_coding, component, expected_payload):

...
def test_create(patient_class, profile_urls, identifiers, active, managing_organization, names, gender, birth_date, addresses, telecoms, communications, update_patient_sc2_payload):
    expected = update_patient_sc2_payload
    scenario = 2

from fixtures.condition_imri_comorb_2024 import *


def test_create(condition_class, profile_urls, clinical_status_coding, clinical_status_text, category_coding, code_coding, code_text, subject, encounter, recorded_date, expected_payload):
    expected = expected_payload

    condition_class.set_profile_urls(profile_urls)

    condition_class.set_clinical_status_coding(clinical_status_coding)
    condition_class.set_clinical_status_text(clinical_status_text)

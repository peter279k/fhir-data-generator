from fixtures.composition_imri_operation_2024 import *


def test_create(composition_class, profile_urls, status, type_coding, subject, date, author, title, section, expected_payload):

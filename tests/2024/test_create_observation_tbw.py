from fixtures.observation_tbw import *


def test_create(observation_class, profile_urls, status, category_coding, code_coding, code_text, subject, effective_datetime, performer, value_quantity, has_member, expected_payload):
